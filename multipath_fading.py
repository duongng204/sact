...
class multipath_fading(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "multipath_fading", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("multipath_fading")
        ...
        self.timming_bw = timming_bw = 2*pi/100
        ...
        self.iir_filter_xxx_0 = filter.iir_filter_ccc([1, 0.5], [1], True)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(8, timming_bw, rx_taps, 32, 16, 1.5, 1)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_ic([(-0.707-0.707j), (-1+0j), (-0.707+0.707j), (0+1j), (0.707+0.707j), (1+0j), (0.707-0.707j), (0-1j)], 1)
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_const_sink_x_0_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.pfb_arb_resampler_xxx_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.qtgui_const_sink_x_0_0_0, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.iir_filter_xxx_0, 0))
        self.connect((self.iir_filter_xxx_0, 0), (self.blocks_throttle2_1, 0))
    ...
    def get_timming_bw(self):
        return self.timming_bw

    def set_timming_bw(self, timming_bw):
        self.timming_bw = timming_bw
        self.digital_pfb_clock_sync_xxx_0.set_loop_bandwidth(self.timming_bw)
