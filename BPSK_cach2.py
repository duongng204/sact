...
class BPSK_cach2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSK_cach2")
        ...
        self.center_freq = center_freq = 850000000
        ...
        self.qtgui_time_sink_x_1.set_update_time(0.2)
        ...
        self.qtgui_const_sink_x_0_0_0 = qtgui.const_sink_c(
            (1024*8), #size
            'Tx_Constellation', #name
            1, #number of inputs
            None # parent
        )
        self.qtgui_const_sink_x_0_0_0.set_update_time(0.10)
        self.qtgui_const_sink_x_0_0_0.set_y_axis((-5), 5)
        self.qtgui_const_sink_x_0_0_0.set_x_axis((-5), 5)
        ...
        self.iio_pluto_sink_0.set_bandwidth(40000000)
        ...
        self.analog_random_uniform_source_x_0 = analog.random_uniform_source_b(0, 15, 0)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_const_sink_x_0_0_0, 0))
...
def main(top_block_cls=BPSK_cach2, options=None):
