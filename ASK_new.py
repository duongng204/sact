...
class ASK_new(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ASK_new")
        ...
        self.sps = sps = 100
        self.signal_freq = signal_freq = 10000
        self.samp_rate = samp_rate = 20000000
        self.rx_gain = rx_gain = 10
        self.cen_freq = cen_freq = 850000000
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('usb:1.3.5' if 'usb:1.3.5' else iio.get_pluto_uri(), [True, True], 32768)
        self.iio_pluto_source_0.set_len_tag_key('packet_len')
        self.iio_pluto_source_0.set_frequency(cen_freq)
        ...
        self.iio_pluto_sink_0.set_frequency(cen_freq)
        self.iio_pluto_sink_0.set_samplerate(samp_rate)
        self.iio_pluto_sink_0.set_attenuation(0, tx_attenuation)
        self.iio_pluto_sink_0.set_filter_params('Auto', '', 0, 0)
        self.blocks_vector_source_x_1 = blocks.vector_source_c((0,0.25,0.5,0.75), True, 1, [])
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_gr_complex*1, sps)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, cen_freq, 1, 0, 0)
        ...
        self.connect((self.blocks_repeat_0, 0), (self.qtgui_freq_sink_x_1_0, 0))
    ...
    def set_cen_freq(self, cen_freq):
        ...
        self.analog_sig_source_x_0.set_frequency(self.cen_freq)
        self.iio_pluto_sink_0.set_frequency(self.cen_freq)
        self.iio_pluto_source_0.set_frequency(self.cen_freq)




def main(top_block_cls=ASK_new, options=None):
